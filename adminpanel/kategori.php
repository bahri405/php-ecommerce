...
<body>
  ...
  <div class="container my-5 col-lg-12 col-md-6">
    ...
    <form action="" method="post">
      ...
      <div>
        <button class="btn btn-primary mt-3" name="simpan_kategori" type="submit">Simpan</button>
      </div>
    </form>
    ...
    <?php 
      ...
      if(isset($_POST['simpan_kategori'])){
        ...
        if($jumlahDataKategoriBaru > 0){
          ?>
          <div class="alert alert-warning mt-3" role="alert">data sudah ada</div>
        <?php
        }
        else {
        ...
        <tbody>
          ...
          ?>
            <tr>
              ...
              <td>
                <a href="kategori-detail.php?p=<?php echo $data['id']; ?>"  class="btn btn-info"><i class="fas fa-search"></i>
